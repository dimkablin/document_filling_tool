...
NAME = 'document_filling_tool'
SHORT_DESCRIPTION = "Document filling tool."
URL = "https://github.com/dimakblin/document_filling_tool"
AUTHOR = 'TATITNEFT'
EMAIL = '-'
...
setup(name=NAME,
      ...
      url=URL,
      packages=find_packages(include=["document_filling_tool*"],
