...
import click
import logging
from document_filling_tool.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("document_filling_tool.app.utils.logging.click.style",
    ...
    @mock.patch("document_filling_tool.app.utils.logging.logging.Formatter")
